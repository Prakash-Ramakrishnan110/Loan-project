...
def generate_report(metrics_before, bias_before, metrics_after=None, bias_after=None, sensitive_col=None, model_type=None, mitigation_method=None):
...
def generate_pdf_report(metrics_before, bias_before, metrics_after=None, bias_after=None, sensitive_col=None, model_type=None, mitigation_method=None):
    if not FPDF:
        return None
    pdf = CompliancePDF()
    pdf.add_page()
