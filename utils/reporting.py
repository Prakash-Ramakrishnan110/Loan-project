...
class CompliancePDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'LoanGuard AI | Fairness Audit & Compliance Report', border=False, ln=1, align='L')
...
def generate_report(
    ...
    report.append("---")
    report.append(
        "\n*This report was generated by LoanGuard AI -- "
        "Automated Fairness Audit Pipeline v2.0*"
    )
